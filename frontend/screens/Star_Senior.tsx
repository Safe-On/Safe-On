    ...
    <View style={styles.card}>
      ...
      <View style={styles.rowBetween}>
        ...
        <View style={styles.row}>
          ...
          >
            <MaterialIcons name="star" size={40} color="#FACC15" />
          </TouchableOpacity>
        </View>
      </View>
      ...
      <View style={styles.infoRow}>
        ...
        <View style={styles.infoRight}>
          ...
          {!!item?.address && (
            ...
            >
              <MaterialIcons name="map" size={25} color="#2563EB" />
            </TouchableOpacity>
          )}
        </View>
      </View>
      ...
      <View style={styles.infoRow}>
        ...
        <View style={styles.infoRight}>
          ...
          {!!item?.phone && (
            ...
            >
              <MaterialIcons name="phone" size={25} color="#2563EB" />
            </TouchableOpacity>
          )}
        </View>
      </View>
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <View style={styles.emptyWrap}>
            <MaterialIcons name="star-border" size={40} />
...
const styles = StyleSheet.create({
  ...
  title: { fontWeight: "bold", fontSize: 35 },
  ...
  name: { fontSize: 25, fontWeight: "600", flexShrink: 1, paddingRight: 8 },
  iconBtn: { padding: 4 },

  infoRow: { flexDirection: "row", alignItems: "center", marginTop: 8 },
  infoLabel: { width: 40, fontSize: 15, color: "#666", },
  infoRight: {
    flex: 1,
    flexDirection: "row",
    alignItems: "center",
  ...
  infoValue: { flex: 1, fontSize: 20, color: "#333", marginRight: 8 },
  infoAction: { paddingHorizontal: 4, paddingVertical: 2 },

  separator: { height: 1, backgroundColor: "#F0F0F0" },

  emptyWrap: { alignItems: "center", gap: 6 },
  emptyTitle: { fontSize: 35, fontWeight: "600", marginTop: 8 },
  emptySub: { fontSize: 20, color: "#666" },
});
