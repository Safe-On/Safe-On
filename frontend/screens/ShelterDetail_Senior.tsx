...
export default function ShelterDetail_Senior() {
    ...
    <SafeAreaView style={styles.SafeAreaView} edges={["top", "left", "right"]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.nameRow}>
          ...
          >
            <MaterialIcons name="volume-up" size={25} color="#111827" />
          </TouchableOpacity>
        </View>
...
const styles = StyleSheet.create({
  ...
  infoLabel: { color: "#475467", marginLeft: 6, marginRight: 8, fontSize: 23 },
  infoValue: { flex: 1, color: "#101828", fontSize: 20 },
